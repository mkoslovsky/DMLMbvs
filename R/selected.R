...
selected <- function( dmlm_obj = NULL, threshold = c(0.5, 0.5), plotting = FALSE, burnin = 0 ){
  ...
  return( list( selected_zeta = selected_zeta, selected_xi = selected_xi, mppi_zeta = zeta_means, mppi_xi = xi_means) )
}
